...
struct MockData {
    ...
    static func makeStubVideoEpisodePodcasts() -> [DiscoverEpisode] {
        ...
        var podcastsUuids: [String] = ["b0689300-ecd3-012e-e054-525400c11844", "68504d20-dc2b-012e-da14-525400c11844"]
        var podcastsNames: [String] = ["This Week in Tech (Video)", "TED Talks Music"]
        var episodesUuid: [String] = ["ed625ff3-d996-4d82-8921-0b823297bdfc", "cede2a30-0163-0133-1b93-059c869cc4eb"]
        var episodesTitle: [String] = ["The Great Beagle Migration - Pope Leo XIV's 1st Encyclical & Ferrari's 1st EV", "An 11-year-old prodigy performs old-school jazz | Joey Alexander"]
        var urls: [String] = ["https://pscrb.fm/rss/p/mgln.ai/e/294/cdn.twit.tv/video/twit/twit1086/twit1086_h264m_1920x1080.mp4", "https://download.ted.com/products/87704.mp4?apikey=172BB350-0009"]

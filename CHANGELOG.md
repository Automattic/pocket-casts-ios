...
- Fix a closed transcript continuing to run in the background during playback after you close the player [#5282](https://github.com/Automattic/pocket-casts-ios/pull/5282)

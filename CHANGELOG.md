...
- What's New no longer shows dots for the messages that were already there the first time you open the app, only for new ones [#5232](https://github.com/Automattic/pocket-casts-ios/pull/5232)

...
- Fix the long pressed bookmark's title snapping into place instead of animating with the rest of the row when entering the multi selection [#4915](https://github.com/Automattic/pocket-casts-ios/pull/4915)

            ...
            VStack(alignment: .leading, spacing: 0) {
                ZStack {
                    ...
                    HStack(alignment: .top) {
                        EpisodeView(episode: firstEpisode, topText: isPlaying ? Text(L10n.Localizable.nowPlaying.localizedUppercase) : Text(L10n.Localizable.podcastTimeLeft(CommonWidgetHelper.durationString(duration: firstEpisode.duration)).localizedUppercase))
                        Spacer()

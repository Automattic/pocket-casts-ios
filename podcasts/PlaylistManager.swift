...
class PlaylistManager {
    ...
    @discardableResult
    class func queueAutoDownloads(for playlist: EpisodeFilter, downloadsAllowedNow: Bool, dataManager: DataManager = .shared, downloadManager: DownloadManager = .shared) -> [String] {
        guard playlist.autoDownloadEpisodes else { return [] }

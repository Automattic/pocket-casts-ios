...
extension DownloadsViewController: MultiSelectActionDelegate {
    ...
    func updateSelectAllBtn() {
        ...
        let leftButtonTitle = MultiSelectHelper.shouldSelectAll(onCount: selectedEpisodes.count, totalCount: episodeCount()) ? L10n.Localizable.selectAll : L10n.Localizable.deselectAll

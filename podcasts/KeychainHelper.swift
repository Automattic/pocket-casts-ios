...
class KeychainHelper {
    ...
    @discardableResult
    class func save(string: String?, key: String, accessibility: CFTypeRef) -> Bool {
        KeychainHelper.shared.save(value: string, key: key, accessibility: accessibility)
    }

    @discardableResult
    class func removeKey(_ key: String) -> Bool {
        KeychainHelper.shared.save(value: nil, key: key, accessibility: kSecAttrAccessibleAlways)
    }

    class func string(for key: String) -> String? {

...
/// Preview content shown above the long-press context menu on the mini player
/// (Liquid Glass). Displays the episode artwork on the leading side and the
/// published date, title, and either a 3-line description or — when the
/// description is unavailable — the episode's duration / size details on the
/// trailing side.
final class MiniPlayerLongPressPreviewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dateLabel.textColor = ThemeColor.primaryText02()
        ...
        detailLabel.textColor = ThemeColor.primaryText02()

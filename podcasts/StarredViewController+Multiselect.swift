...
extension StarredViewController: MultiSelectActionDelegate {
    ...
    func updateSelectAllBtn() {
        ...
        let leftButtonTitle = MultiSelectHelper.shouldSelectAll(onCount: selectedEpisodes.count, totalCount: episodes.count) ? L10n.Localizable.selectAll : L10n.Localizable.deselectAll

...
class TranscriptViewController: PlayerItemViewController {
    ...
    private lazy var premiumView: UIView = {
        ...
        title.text = "This transcript is automatically generated by Pocket Casts."
        ...
        description.text = "Subscribe to Plus to get access to it and other Premium features like bookmarks and folders."
        ...
        button.setTitle("Subscribe to Plus", for: .normal)
        button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 18)
        button.setTitleColor(UIColor(hex: "#181818"), for: .normal)
        button.addTarget(self, action: #selector(showUpsellView), for: .touchUpInside)
        textContainer.addSubview(button)

        let textContainerLeadingConstraint = textContainer.leadingAnchor.constraint(equalTo: containerView.leadingAnchor)
        let textContainerTrailingConstraint = textContainer.trailingAnchor.constraint(equalTo: containerView.trailingAnchor)
        self.textContainerLeadingConstraint = textContainerLeadingConstraint
        self.textContainerTrailingConstraint = textContainerTrailingConstraint
        ...
        NSLayoutConstraint.activate(
            [
                ...
                textContainer.topAnchor.constraint(equalTo: badge.bottomAnchor, constant: 24),
        ...
        NSLayoutConstraint.activate(
            [
                title.topAnchor.constraint(equalTo: textContainer.topAnchor),
                title.leadingAnchor.constraint(equalTo: textContainer.leadingAnchor),
                title.trailingAnchor.constraint(equalTo: textContainer.trailingAnchor),
                description.topAnchor.constraint(equalTo: title.bottomAnchor, constant: 16),
                description.leadingAnchor.constraint(equalTo: textContainer.leadingAnchor),
                description.trailingAnchor.constraint(equalTo: textContainer.trailingAnchor),
                button.bottomAnchor.constraint(equalTo: textContainer.bottomAnchor),
                button.leadingAnchor.constraint(equalTo: textContainer.leadingAnchor),
                button.trailingAnchor.constraint(equalTo: textContainer.trailingAnchor),
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            if FeatureFlag.generatedTranscripts.enabled,
               transcriptManager?.hasGeneratedTranscripts == true {
                self.showPremiumView(show: false)
            }
        }
    }

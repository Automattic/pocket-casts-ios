...
internal enum L10n {
  ...
  /// A common string used throughout the app. Title for the prompt to navigate the user to the episode details.
  internal static var goToEpisode: String { return L10n.tr("Localizable", "go_to_episode", fallback: "Go to Episode") }
  ...
  /// A common string used throughout the app. Prompt to immediately start playing the selected episode.
  internal static var playNow: String { return L10n.tr("Localizable", "play_now", fallback: "Play Now") }

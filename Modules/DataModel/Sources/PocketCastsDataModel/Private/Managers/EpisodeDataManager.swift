...
class EpisodeDataManager {
    ...
    private func createValuesFrom(episode: Episode, includeIdForWhere: Bool = false) -> [Any] {
        var values = [Any]()
        values.append(episode.id)
        values.append(DBUtils.dateNullIfNil(value: episode.addedDate))
        values.append(DBUtils.ensureTimeInterval(value: episode.lastDownloadAttemptDate))
        ...
        values.append(DBUtils.dateNullIfNil(value: episode.publishedDate))
        ...
        values.append(DBUtils.dateNullIfNil(value: episode.lastPlaybackInteractionDate))
        ...
        values.append(episode.archivedModified)
        values.append(DBUtils.ensureTimeInterval(value: episode.lastArchiveInteractionDate))

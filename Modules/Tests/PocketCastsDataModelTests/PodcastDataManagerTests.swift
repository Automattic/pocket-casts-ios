...
final class PodcastDataManagerTests: DataManagerTestCase {
    ...
    func testFindPodcastByUuidReturnsPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotNil(found, "Should find podcast")
            XCTAssertEqual(found?.uuid, podcast.uuid, "UUID should match")
            XCTAssertEqual(found?.title, podcast.title, "Title should match")
        }
    }
    ...
    func testFindPodcastByUuidReturnsNilForNonExistent() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNil(found, "Should not find non-existent podcast")
        }
    }
    ...
    func testFindPodcastByUuidExcludesUnsubscribedByDefault() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNil(found, "Should not find unsubscribed podcast by default")
        }
    }
    ...
    func testFindPodcastByUuidIncludesUnsubscribedWhenRequested() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotNil(found, "Should find unsubscribed podcast when includeUnsubscribed is true")
        }
    }
    ...
    func testAllPodcastsReturnsAllSubscribedPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 3, "Should return 3 podcasts")
        }
    }
    ...
    func testAllPodcastsExcludesUnsubscribedByDefault() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should exclude unsubscribed podcast")
            XCTAssertTrue(podcasts.allSatisfy { $0.subscribed == 1 }, "All podcasts should be subscribed")
        }
    }
    ...
    func testAllPodcastsIncludesUnsubscribedWhenRequested() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should include unsubscribed podcast")
        }
    }
    ...
    func testAllPodcastsReturnsEmptyWhenNone() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(podcasts.isEmpty, "Should return empty array when no podcasts")
        }
    }
    ...
    func testRandomPodcastsReturnsSubset() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertGreaterThan(podcasts.count, 0, "Should return some podcasts")
            XCTAssertLessThanOrEqual(podcasts.count, 10, "Should not return more than exist")
        }
    }
    ...
    func testRandomPodcastsReturnsAllWhenFew() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return all podcasts when few exist")
        }
    }
    ...
    func testCountOfPodcastsInFolderCountsPodcastsInFolder() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(count, 2, "Should count only podcasts in folder")
        }
    }
    ...
    func testCountOfPodcastsInRootFolderCountsUnfolderedPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(count, 2, "Should count only podcasts not in a folder")
        }
    }
    ...
    func testCountOfPodcastsInFolderExcludesUnsubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(count, 1, "Should exclude unsubscribed podcasts")
        }
    }
    ...
    func testAllUnsyncedPodcastsReturnsUnsyncedPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return only unsynced podcasts")
            XCTAssertTrue(podcasts.allSatisfy { $0.syncStatus == SyncStatus.notSynced.rawValue }, "All should be unsynced")
        }
    }
    ...
    func testPodcastUnfinishedCountsReturnsCorrectCounts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(counts[podcast1.uuid], 2, "Podcast 1 should have 2 unfinished")
            XCTAssertEqual(counts[podcast2.uuid], 1, "Podcast 2 should have 1 unfinished")
        }
    }
    ...
    func testPodcastUnfinishedCountsExcludesArchivedEpisodes() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(counts[podcast.uuid], 1, "Should exclude archived episode")
        }
    }
    ...
    func testDeleteRemovesPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNil(found, "Should delete podcast")
        }
    }
    ...
    func testMarkAllPodcastsSyncedMarksAllAsSynced() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(unsynced.isEmpty, "All podcasts should be synced")
        }
    }
    ...
    func testMarkAllPodcastsUnsyncedMarksSubscribedAsUnsynced() throws {
        try runWithDataManager { dataManager in
            ...
            let unsynced = dataManager.allUnsyncedPodcasts()
            XCTAssertEqual(unsynced.count, 1, "Only subscribed podcast should be unsynced")
            XCTAssertEqual(unsynced.first?.title, "Subscribed", "Subscribed podcast should be unsynced")
        }
    }
    ...
    func testUpdateAllPodcastGroupingUpdatesGrouping() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { $0.episodeGrouping == PodcastGrouping.season.rawValue }, "All podcasts should have season grouping")
        }
    }
    ...
    func testUpdateAllPodcastGroupingOnlyUpdatesSubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(subscribed.allSatisfy { $0.episodeGrouping == PodcastGrouping.season.rawValue }, "Subscribed should have season grouping")
            XCTAssertTrue(unsubscribed.allSatisfy { $0.episodeGrouping == PodcastGrouping.none.rawValue }, "Unsubscribed should be unchanged")
        }
    }
    ...
    func testUpdateAllShowArchivedUpdatesShowArchived() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { $0.showArchived == true }, "All podcasts should show archived")
        }
    }
    ...
    func testUpdateAllShowArchivedOnlyUpdatesSubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(subscribed.allSatisfy { $0.showArchived == true }, "Subscribed should show archived")
            XCTAssertTrue(unsubscribed.allSatisfy { $0.showArchived == false }, "Unsubscribed should be unchanged")
        }
    }
    ...
    func testAllPodcastsInFolderReturnsPodcastsInFolder() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return only podcasts in folder")
            XCTAssertTrue(podcasts.allSatisfy { $0.folderUuid == folder.uuid }, "All should have folder UUID")
        }
    }
    ...
    func testDeleteFolderRemovesPodcastsFromFolder() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotNil(found, "Podcast should still exist")
            XCTAssertNil(found?.folderUuid, "Podcast should no longer have folder UUID")
        }
    }
    ...
    func testAllPodcastsOrderedByAddedDateReturnsSortedByDate() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 3, "Should return all podcasts")
            // Sorted by added date ascending (oldest first)
            XCTAssertEqual(podcasts.first?.title, "Oldest", "Oldest should be first")
            XCTAssertEqual(podcasts.last?.title, "Newest", "Newest should be last")
        }
    }
    ...
    func testAllPodcastsOrderedByAddedDateExcludesUnsubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 1, "Should exclude unsubscribed")
            XCTAssertEqual(podcasts.first?.title, "Subscribed", "Should only include subscribed")
        }
    }
    ...
    func testAllPodcastsOrderedByTitleReturnsSortedByTitle() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 3, "Should return all podcasts")
            XCTAssertEqual(podcasts.first?.title, "Alpha Podcast", "Alpha should be first")
            XCTAssertEqual(podcasts.last?.title, "Zebra Podcast", "Zebra should be last")
        }
    }
    ...
    func testAllUnsubscribedPodcastUuidsReturnsOnlyUnsubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(uuids.count, 2, "Should return 2 unsubscribed UUIDs")
            XCTAssertTrue(uuids.contains("unsubscribed-uuid-1"), "Should contain first unsubscribed UUID")
            XCTAssertTrue(uuids.contains("unsubscribed-uuid-2"), "Should contain second unsubscribed UUID")
            XCTAssertFalse(uuids.contains("subscribed-uuid"), "Should not contain subscribed UUID")
        }
    }
    ...
    func testAllUnsubscribedPodcastsReturnsOnlyUnsubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return 2 unsubscribed podcasts")
            XCTAssertTrue(podcasts.allSatisfy { $0.subscribed == 0 }, "All should be unsubscribed")
        }
    }
    ...
    func testAllPaidPodcastsReturnsPaidOnly() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return 2 paid podcasts")
            XCTAssertTrue(podcasts.allSatisfy { $0.isPaid }, "All should be paid")
        }
    }
    ...
    func testAllOverrideGlobalArchivePodcastsReturnsOverridingPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should return 2 podcasts with override")
            XCTAssertTrue(podcasts.allSatisfy { $0.overrideGlobalArchive }, "All should have override")
        }
    }
    ...
    func testAllOverrideGlobalArchivePodcastsExcludesUnsubscribed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 1, "Should exclude unsubscribed")
            XCTAssertEqual(podcasts.first?.title, "Subscribed Override", "Should only include subscribed")
        }
    }
    ...
    func testSearchPodcastsMatchesTitle() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 2, "Should find 2 podcasts matching Tech")
        }
    }
    ...
    func testSearchPodcastsMatchesAuthor() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 1, "Should find 1 podcast by author")
            XCTAssertEqual(podcasts.first?.author, "John Smith", "Should match author")
        }
    }
    ...
    func testSearchPodcastsIsCaseInsensitive() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.count, 1, "Should match case-insensitively")
        }
    }
    ...
    func testSearchPodcastsReturnsEmptyForNoMatch() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(podcasts.isEmpty, "Should return empty for no match")
        }
    }
    ...
    func testSearchPodcastsHandlesEmptyTerm() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(podcasts.isEmpty, "Should return empty for empty term")
        }
    }
    ...
    func testSearchPodcastsHandlesWhitespaceTerm() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertTrue(podcasts.isEmpty, "Should return empty for whitespace term")
        }
    }
    ...
    func testCountReturnsSubscribedPodcastCount() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(count, 2, "Should count only subscribed podcasts")
        }
    }
    ...
    func testCountReturnsZeroWhenEmpty() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(count, 0, "Should return 0 when no podcasts")
        }
    }
    ...
    func testBulkSetFolderUuidSetsFolderOnPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(found1?.folderUuid, folder.uuid, "Podcast 1 should be in folder")
            XCTAssertEqual(found2?.folderUuid, folder.uuid, "Podcast 2 should be in folder")
            XCTAssertNil(found3?.folderUuid, "Podcast 3 should not be in folder")
        }
    }
    ...
    func testBulkSetFolderUuidRemovesPreviousPodcastsFromFolder() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNil(foundOld?.folderUuid, "Old podcast should be removed from folder")
            XCTAssertEqual(foundNew?.folderUuid, folder.uuid, "New podcast should be in folder")
        }
    }
    ...
    func testSaveSortOrdersUpdatesPodcastSortOrders() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(found1?.sortOrder, 10, "Podcast 1 sort order should be updated")
            XCTAssertEqual(found2?.sortOrder, 20, "Podcast 2 sort order should be updated")
        }
    }
    ...
    func testSaveSortOrdersMarksPodcastsUnsynced() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertEqual(found?.syncStatus, SyncStatus.notSynced.rawValue, "Podcast should be marked unsynced")
        }
    }
    ...
    func testSavePushSettingUpdatesPodcastPushEnabled() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertTrue(found?.pushEnabled ?? false, "Push should be enabled")
        }
    }
    ...
    func testSetPushForAllPodcastsEnablesPushForAll() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { $0.pushEnabled }, "All podcasts should have push enabled")
        }
    }
    ...
    func testSetPushForAllPodcastsDisablesPushForAll() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { !$0.pushEnabled }, "All podcasts should have push disabled")
        }
    }
    ...
    func testSaveAutoAddToUpNextUpdatesPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertEqual(found?.autoAddToUpNext, AutoAddToUpNextSetting.addFirst.rawValue, "Auto add to up next should be updated")
        }
    }
    ...
    func testSaveAutoAddToUpNextForAllPodcastsUpdatesAll() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { $0.autoAddToUpNext == AutoAddToUpNextSetting.addLast.rawValue }, "All podcasts should have auto add to up next set")
        }
    }
    ...
    func testUpdateAutoAddToUpNextOnlyUpdatesTargetedPodcasts() throws {
        try runWithDataManager { dataManager in
            ...
            let foundTarget1 = try XCTUnwrap(dataManager.findPodcast(uuid: target1.uuid), "target-1 should exist")
            let foundTarget2 = try XCTUnwrap(dataManager.findPodcast(uuid: target2.uuid), "target-2 should exist")

            dataManager.updateAutoAddToUpNext(to: .addLast, for: [foundTarget1, foundTarget2])

            XCTAssertEqual(dataManager.findPodcast(uuid: target1.uuid)?.autoAddToUpNext, AutoAddToUpNextSetting.addLast.rawValue, "target-1 should be updated")
            XCTAssertEqual(dataManager.findPodcast(uuid: target2.uuid)?.autoAddToUpNext, AutoAddToUpNextSetting.addLast.rawValue, "target-2 should be updated")
            // A scoped update must NOT modify podcasts that weren't passed in.
            XCTAssertEqual(dataManager.findPodcast(uuid: untouched.uuid)?.autoAddToUpNext, AutoAddToUpNextSetting.addLast.rawValue, "podcast not in the list must keep its original setting")
        }
    }
    ...
    func testUpdateAutoAddToUpNextStoresExactValue() throws {
        try runWithDataManager { dataManager in
            let podcast = self.createTestPodcast(uuid: "podcast-1", title: "Podcast", autoAddToUpNext: AutoAddToUpNextSetting.off.rawValue, dataManager: dataManager)
            let found = try XCTUnwrap(dataManager.findPodcast(uuid: podcast.uuid), "podcast should exist")

            dataManager.updateAutoAddToUpNext(to: .addFirst, for: [found])

            // addFirst (2) must round-trip exactly, not be clamped to addLast (1).
            XCTAssertEqual(dataManager.findPodcast(uuid: podcast.uuid)?.autoAddToUpNext, AutoAddToUpNextSetting.addFirst.rawValue, "addFirst should be stored exactly")
        }
    }
    ...
    func testSetDownloadSettingForAllPodcastsUpdatesAll() throws {
        try runWithDataManager { dataManager in
            ...
            let podcasts = dataManager.allPodcasts(includeUnsubscribed: false)
            XCTAssertTrue(podcasts.allSatisfy { $0.autoDownloadSetting == AutoDownloadSetting.latest.rawValue }, "All podcasts should have download setting updated")
        }
    }
    ...
    func testSavePodcastDownloadSettingUpdatesPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertEqual(found?.autoDownloadSetting, AutoDownloadSetting.latest.rawValue, "Download setting should be updated")
        }
    }
    ...
    func testSaveAutoArchiveLimitUpdatesPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertEqual(found?.autoArchiveEpisodeLimit, 10, "Auto archive limit should be updated")
        }
    }
    ...
    func testSetPodcastImageVersionDoesNotCrash() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertNotNil(found, "Podcast should still exist after image version update")
        }
    }
    ...
    func testUpdatePodcastFolderUpdatesFolderAndSortOrder() throws {
        try runWithDataManager { dataManager in
            ...
            let found = dataManager.findPodcast(uuid: podcast.uuid)
            XCTAssertEqual(found?.folderUuid, folder.uuid, "Folder UUID should be updated")
            XCTAssertEqual(found?.sortOrder, 5, "Sort order should be updated")
        }
    }
    ...
    func testMarkAllPodcastsUnsyncedWhereLastSyncAtNotDoesNotCrash() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotNil(found1, "Podcast 1 should still exist")
            XCTAssertNotNil(found2, "Podcast 2 should still exist")
        }
    }
    ...
    func testAllPodcastsOrderedByNewestEpisodesReturnsSortedByLatestRelease() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertGreaterThanOrEqual(podcasts.count, 3, "Should return all podcasts")
            // The podcast with the newest episode should be first
            XCTAssertEqual(podcasts.first?.uuid, podcast2.uuid, "Podcast with newest episode should be first")
        }
    }
    ...
    func testAllPodcastsOrderedByLastPlayedEpisodesReturnsSortedByLastPlayed() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(podcasts.first?.uuid, podcast2.uuid, "Podcast with most recently played episode should be first")
        }
    }
    ...
    func testSaveInsertsNewPodcastWithAllFields() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotNil(found, "Should find saved podcast")
            XCTAssertEqual(found?.uuid, "save-test-uuid", "UUID should match")
            XCTAssertEqual(found?.title, "Save Test Podcast", "Title should match")
            XCTAssertEqual(found?.author, "Test Author", "Author should match")
            XCTAssertEqual(found?.subscribed, 1, "subscribed should match")
            XCTAssertEqual(found?.sortOrder, 5, "sortOrder should match")
            XCTAssertEqual(found?.syncStatus, SyncStatus.notSynced.rawValue, "syncStatus should match")
            XCTAssertEqual(found?.showArchived, true, "showArchived should match")
            XCTAssertEqual(found?.episodeGrouping, PodcastGrouping.season.rawValue, "episodeGrouping should match")
            XCTAssertEqual(found?.isPaid, true, "isPaid should match")
            XCTAssertEqual(found?.overrideGlobalArchive, true, "overrideGlobalArchive should match")
            XCTAssertEqual(found?.pushEnabled, true, "pushEnabled should match")
            XCTAssertEqual(found?.autoAddToUpNext, AutoAddToUpNextSetting.addFirst.rawValue, "autoAddToUpNext should match")
            XCTAssertEqual(found?.autoDownloadSetting, AutoDownloadSetting.latest.rawValue, "autoDownloadSetting should match")
            XCTAssertEqual(found?.autoArchiveEpisodeLimit, 5, "autoArchiveEpisodeLimit should match")
        }
    }
    ...
    func testSaveUpdatesExistingPodcast() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(found?.author, "Updated Author", "Author should be updated")
            XCTAssertEqual(found?.showArchived, true, "showArchived should be updated")
            XCTAssertEqual(found?.episodeGrouping, PodcastGrouping.season.rawValue, "episodeGrouping should be updated")
    ...
    func testSaveGeneratesIdIfZero() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertNotEqual(podcast.id, 0, "ID should be generated")

            let found = dataManager.findPodcast(uuid: "id-test-uuid")
            XCTAssertNotNil(found, "Should find podcast with generated ID")
            XCTAssertNotEqual(found?.id, 0, "Found podcast should have non-zero ID")
        }
    }
    ...
    func testSavePreservesOptionalFields() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(found?.podcastDescription, "Test description", "description should be preserved")
            XCTAssertEqual(found?.podcastUrl, "https://example.com/feed.xml", "podcastUrl should be preserved")
            XCTAssertEqual(found?.podcastCategory, "Technology", "podcastCategory should be preserved")
            XCTAssertEqual(found?.episodeSortOrder, 2, "episodeSortOrder should be preserved")
        }
    }
    ...
    func testSaveWithFolderUuid() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(found?.folderUuid, folder.uuid, "folderUuid should be preserved")
        }
    }

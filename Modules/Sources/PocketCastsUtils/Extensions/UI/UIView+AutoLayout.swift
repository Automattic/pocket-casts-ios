...
extension UIView {
    ...
    public func pinEdges(
        ...
        guard let target = prepareForAutoLayout(target: target) else { return [] }
        ...
        return activate(constraints, priority: priority)
    }
    ...
    private func prepareForAutoLayout(target: AutoLayoutItem?) -> AutoLayoutItem? {
    ...
    private func activate(_ constraints: [NSLayoutConstraint], priority: UILayoutPriority?) -> [NSLayoutConstraint] {
        if let priority {
